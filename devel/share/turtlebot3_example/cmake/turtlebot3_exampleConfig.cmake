...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_example_SOURCE_PREFIX /home/pig/artjom-met0310_av/src/turtlebot3/turtlebot3_example)
  set(turtlebot3_example_DEVEL_PREFIX /home/pig/artjom-met0310_av/devel)
  ...
  set(turtlebot3_example_INSTALL_PREFIX /home/pig/artjom-met0310_av/install)
...
if(NOT "/home/pig/artjom-met0310_av/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pig/artjom-met0310_av/src/turtlebot3/turtlebot3_example/${idir}'.  ${_report}")
    endif()
